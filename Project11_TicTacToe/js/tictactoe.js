...
let selectedSquares =[];
// This variable keeps track of when it's between games
let transition = false;

//This function is for placeing an X or O in a square.
function placeXorO(squareNumber){
    //This condition ensures a square hasn't been selected already.
    //The .some() method is used to check each element of selectedSquare array
    //to see if it contains the square number clicked on.
    if (!selectedSquares.some(element => element.includes(squareNumber))){
        //This varriable retrieves the html element id that was clicked.
        ...
        //squareNumber and activePlayer are concatenated together and added to arry.
        ...
        //This conition checks to see if it is computer turn.
        if(activePlayer === 'O'){
    ...
    // this function runs the computers turn
    ...
    // This function makes our body element tempoarily unclickable
    function disableClick(){
        // This makes our body unclicalbe.
        body.style.pointEvents = "none";
        // This make our boday clicable again after 1 second
    ...
    //This function utilizes html canvas to drwa win lines.
    ...
    //This line accesses our html canvas element.
        ...
        function animateLineDrawing() {
            ...
            c.stroke();
            // This conition checks if we've reached the endpoint.
            if (x1 <= x2 && y1 <= y2) {
            ...
            //This condition is similar to the on above. This is necessary for the 642 win condition
            if(x1 <= x2 && y1 >= y2) {
                if (x < x2) { x += 10; }
                if (y > y2) { y -= 10; }
                if (x >= x2 && y <= y2) {cancelAnimationFrame (animationLoop)}
    ...
    function resetGame(){
        //This for loop iterates through each HML square element
        for (let i = 0; i < 9; i++){
            //this variable gets the html elemtn of i.
            let square = document.getElementById(String(i));
            //This removes our elements backgroundImage.
            square.style.backgroundImage ='';
        }
        //This resets our array so its empty
