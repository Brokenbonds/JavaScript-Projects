...
const Calculator = {
    ...
    // this will hold the operator, we set in to null for now
    operator: null,
};
...
function Input_Decimal(dot) {
    //this ensures that accidental clicking of the decimal point doesn't cuase bugs in the operation
...
function Handle_Operator(Next_Operator){
    ...
    //when an operator key is press, we convert the current number displayed on the screen to a number and then store the result in Calculator.First_Operand if it doesn't already exist.
    ...
    if(First_Operand == null){
        ...
        //if operator exists, property looup is performed for the operator in the Perform_Calculation object and the function that matcehs the operator is executed.
...
const keys = document.querySelector('.calcultor-keys');
